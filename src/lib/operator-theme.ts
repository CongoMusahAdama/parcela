...
export function getOperatorStaffTheme(operator: Operator): OperatorStaffTheme {
  return OPERATOR_STAFF_THEME[operator];
}

export function operatorStaffThemeStyle(operator: Operator): React.CSSProperties {
